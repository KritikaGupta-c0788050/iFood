   	 	     ...
   	 	     <tr class="cake-top">
   	 	        ...
   	 	        <td class="cake-text">
   	 	     		<div class="product-text">
   	 	     			<h3 class="classNAME"><%=p_obj3.getName() %></h3>   
 	     	    ...
 	     	    <td class="quantity"> 	 	     	 
   	 	     	  <div class="product-right">
   	 	     	  	<input min="1" type="number" id="quantity" class="classQuant" name="quantity" value="<%=p_obj3.getQuantity() %>" class="form-control input-small">				  
   	 	     	 	<input type="hidden" value="<%=p_obj3.getQuantity() %>"> 
   	 	     	  </div>
   	 	     	</td>
   	 	     	<td class="price">
   	 	     		<h4 style="text-align:center;" class="priceELE">$<%=p_obj3.getPrice() %></h4>	 	     		
   	 	     	</td>
   	 	     	 <td class="top-remove">
   	 	     		<%-- <h4 style="text-align:center;">$<%=p_obj3.getTotal() %></h4> --%>
   	 	     			 <div class="close">
   	 	     			  <form action="removeP" method="post">
   	 	     			 <input type="hidden" name="pName" value="<%=p_obj3.getName() %>">
