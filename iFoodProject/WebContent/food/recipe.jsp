...
<html lang="zxx">
  <head>
    <title>Sapid a Restaurant Category Bootstrap Responsive web Template|Recipe :: w3layouts</title>
    <!--meta tags -->
    <meta charset="UTF-8">
    ...
    <section class="recipe-order py-lg-4 py-md-3 py-sm-3 py-3" id="recipe">
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img src="images/r1.jpg" alt="news image" class="img-fluid">
          </div>
        </div>
        <div class="row mt-lg-5 mt-md-4 mt-3">
          <div class="col-lg-6">
            <img src="images/r2.jpg" alt="news image" class="img-fluid">
          </div>
          <div class="col-lg-6 tasty-recipe-wthree">
            <h4>Lorem ipsum dolor sit amet sed do eiusmod tempor incididunt ut labore et Lorem ipsum</h4>
            <p class="pt-lg-4 pt-3">sed do eiusmod tempor incididunt ut Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet, eiusmod tempor incididunt ut labore et consectetur adipiscing sed do eiusmod tempor incididunt</p>
